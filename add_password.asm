; add_password.asm
; Exporte add_password()
; Utilise les symboles définis dans common_data.asm et appelle xor_encrypt_decrypt
...
.build_entry:
    ...
    ; encrypt entry with master_password
    lea rsi, [rel master_password]
    lea rdi, [rel entry]
    call xor_encrypt_decrypt

    ; open file O_WRONLY|O_CREAT|O_APPEND (1089)
    mov rax, 2
